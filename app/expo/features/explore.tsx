      ...
      <FlashList
        ...
        renderItem={({ item }) => {
          return (
            ...
            >
              <T className={`absolute bottom-0 text-yellow-300 z-40`}>
